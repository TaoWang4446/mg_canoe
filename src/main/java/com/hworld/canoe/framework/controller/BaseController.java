 ...
 * -
 */
public class BaseController<Biz extends BaseDao, Entity> {
    @Autowired
    ...
    @ResponseBody
    public ObjectRestResponse<Entity> get(@PathVariable Long id, @RequestHeader(name = "Authorization") String Authorization) {
